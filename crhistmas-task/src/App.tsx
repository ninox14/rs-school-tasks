  ...
  return (
    <>
      ...
      <footer className="footer">
        ...
        <div className="footer__item">
          <span>2021 © NiNoX</span>
        </div>
        <div className="footer__item">
          <div className="footer__svg footer__svg-rs">
            <a
              className="footer__link"
