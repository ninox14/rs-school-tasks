const numberInputButtons = document.querySelectorAll('.input-button');
const numberInput = document.querySelector('.number-input-text-box');
function init() {
...
numberInputButtons.forEach(el => {
	el.addEventListener('click', e=> {
		setNumber(e);
	})
})

numberInput.addEventListener('onblur', handleNumberInputBlur)